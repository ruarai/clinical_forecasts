...
t_parameters <- list(
  ...
  tar_target(forecast_name, str_c("fc_", date_forecasting, "_test_pf_b_baseline")),
  
  tar_target(raw_nindss, "results/fc_2022-11-25_final/archive/nindss.fst"),
  tar_target(raw_local_cases, "results/fc_2022-11-25_final/archive/local_cases.csv"),
  tar_target(raw_ensemble, "results/fc_2022-11-25_final/archive/ensemble.csv"),
