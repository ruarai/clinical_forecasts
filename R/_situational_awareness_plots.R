...
local_cases_path <- "~/mfluxunimelb/local_cases_input/local_cases_input_2022-12-15.csv"
ensemble_path <- "~/mfluxshared/forecast-outputs/combined_samples_varasc2022-12-09.csv"
date_reporting_line <- ymd("2022-12-15")
