...
results_dir <- "results/fc_2023-06-02_pf/"
local_cases_path <-"~/mfluxunimelb/local_cases_input/local_cases_input_2023-06-01.csv"
...
date_plot_start <- ymd("2023-04-19")
...
simplify_plot <- function(plot, state) {
  ...
  plot + 
    ...
    coord_cartesian(xlim = c(date_plot_start, max_forecast_start_date + ddays(days_horizon)), clip = "off")
}
