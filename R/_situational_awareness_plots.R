...
results_dir <- "results/fc_2023-05-26_final/"
local_cases_path <- "data/local_cases_input_2023-05-25.csv"
ensemble_path <- "data/combined_samples_varasc2023-05-19.csv"
date_reporting_line <- ymd("2023-05-26")
