...
plots_common <- list(
  coord_cartesian(xlim = c(forecast_dates$simulation_start,
                           forecast_dates$forecast_start + ddays(4))),
  scale_x_date("Date", date_labels = "%e/%m", breaks = "months", expand=c(0,0)),
