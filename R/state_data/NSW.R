process_NSW_linelist <- function(linelist_raw_path) {
  
  source("R/age_groups.R")
  
  print(paste0("Using NSW linelist ", linelist_raw_path))
  
  linelist_raw <- readxl::read_xlsx(linelist_raw_path, sheet = 2)
