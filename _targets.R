...
t_parameters <- list(
  tar_target(date_forecasting, ymd("2023-05-26")),
  ...
  tar_target(raw_nindss, "data/COVID-19 UoM 6months-25May2023.csv"),
  tar_target(raw_local_cases, "data/local_cases_input_2023-05-25.csv"),
  ...
  tar_target(raw_ensemble, "data/combined_samples_varasc2023-05-19.csv"),
  tar_target(occupancy_path, "data/occupancy/NAT_2023-05-25_Data for Uni of Melbourne.xlsx"),
