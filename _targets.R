...
t_parameters <- list(
  tar_target(date_forecasting, ymd("2023-03-03")),
  ...
  tar_target(raw_nindss, "data/COVID-19 UoM 6months-2Mar2023.zip"),
  tar_target(raw_local_cases, "data/local_cases_input_2023-03-02.csv"),
  ...
  tar_target(raw_ensemble, "data/combined_samples_varasc2023-02-24.csv"),
  tar_target(occupancy_path, "data/occupancy/NAT_2023-03-02_Data for Uni of Melbourne.xlsx"),
