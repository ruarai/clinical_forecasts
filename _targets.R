...
t_parameters <- list(
  tar_target(date_forecasting, ymd("2023-07-20")),
  ...
  tar_target(raw_nindss, "~/mfluxshared/Health Uploads/COVID-19 UoM 6months-20July2023.zip"),
  tar_target(raw_local_cases, "~/mfluxunimelb/local_cases_input/local_cases_input_2023-07-20.csv"),
  ...
  tar_target(raw_ensemble, "~/mfluxshared/forecast-outputs/combined_samples_varasc2023-07-14.csv"),
  tar_target(occupancy_path, "data/occupancy/NAT_2023-07-20_Data for Uni of Melbourne.xlsx"),
