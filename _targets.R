...
t_parameters <- list(
  tar_target(date_forecasting, ymd("2023-08-03")),
  ...
  tar_target(raw_nindss, "~/mfluxshared/Health Uploads/COVID-19 UoM 6months-03Aug2023.zip"),
  tar_target(raw_local_cases, "~/mfluxunimelb/local_cases_input/local_cases_input_2023-08-03.csv"),
  ...
  tar_target(raw_ensemble, "~/mfluxshared/forecast-outputs/combined_samples_varasc2023-07-28.csv"),
  tar_target(occupancy_path, "data/occupancy/NAT_2023-08-03_Data for Uni of Melbourne.xlsx"),
