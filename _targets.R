...
t_parameters <- list(
  tar_target(date_forecasting, ymd("2023-03-09")),
  ...
  tar_target(raw_nindss, "data/COVID-19 UoM 6months-9Mar2023.csv"),
  tar_target(raw_local_cases, "data/local_cases_input_2023-03-09.csv"),
  ...
  tar_target(raw_ensemble, "data/combined_samples_varasc2023-03-03.csv"),
  tar_target(occupancy_path, "data/occupancy/NAT_2023-03-09_Data for Uni of Melbourne.xlsx"),
