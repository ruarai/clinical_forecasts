...
t_parameters <- list(
  tar_target(date_forecasting, ymd("2023-06-23")),
  ...
  tar_target(raw_nindss, "~/mfluxunimelb/NINDSS_and_state_data/nindss/COVID-19 UoM 6months-22June2023.zip"),
  tar_target(raw_local_cases, "~/mfluxunimelb/local_cases_input/local_cases_input_2023-06-22.csv"),
  ...
  tar_target(raw_ensemble, "~/mfluxshared/forecast-outputs/combined_samples_varasc2023-06-16.csv"),
  tar_target(occupancy_path, "data/occupancy/NAT_2023-06-22_Data for Uni of Melbourne.xlsx"),
